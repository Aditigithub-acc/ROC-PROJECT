...
export default function SalesBlogHero() {
    ...
    return (
        <section className="w-full bg-white flex flex-col">
            ...
            {/* Top Text Section - Animated and styled with Website Theme (#da2929) */}
            <div className="w-full relative pt-32 pb-16 px-4 flex flex-col items-center justify-center text-center overflow-hidden bg-gradient-to-br from-red-50/40 via-white to-gray-50">
                ...
                {/* Decorative Background Blobs - Red Theme */}
            ...
            >
                ...
                {/* Optional subtle gradient overlay at the bottom for smooth transition if needed */}
