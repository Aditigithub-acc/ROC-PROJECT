                ...
                <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                            Basiq360&apos;s DMS includes a robust sales targets management module that offers:
                        </p>

                        <div className="space-y-6 mb-10">
                            {[
                                {
                                    title: "Team-Wide Communication System",
                                    desc: "The DMS includes an announcement system for sharing notifications and updates with the entire team. This feature ensures everyone is informed and aligned, promoting effective team communication."
                                },
                                {
                                    title: "Survey Tool",
                                    desc: "The module includes a survey tool for conducting surveys with dealers and distributors. This feature enables you to gather valuable insights, better understand your partners' needs, and improve relationships."
                                },
                                {
                                    title: "Party-Wise Sales Targets",
                                    desc: "The system allows for the setting of party-wise sales targets. This feature can boost overall sales performance by fostering a sense of competition and accountability. The tool enables tracking and adjusting these targets, providing a dynamic and adaptable way to drive sales."
                                }
                            ].map((item, idx) => (
                                <motion.div 
                                    key={idx}
