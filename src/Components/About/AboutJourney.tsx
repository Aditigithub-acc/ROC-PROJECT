...
const MilestoneCard = memo(({ milestone, index, totalBlades, smoothProgress }: { milestone: Milestone; index: number; totalBlades: number; smoothProgress: MotionValue<number> }) => {
